...
export const Browser = ({}: Types.BrowserTypes) => {
  ...
  const showBackButton = pathSegments.length > 0; // Only show if not at root
  ...
  return (
    <>
      <div className="bg-gray-200 h-screen dark:bg-stone-800 text-2xl p-4 text-stone-700 dark:text-stone-50 inset-0">
